...
public class DisjointSets {
    ...
    public int find(int i) {
    	...
    	if (par[i] == i) return i; // if i is the representative, return i
    	else
    	{
    		par[i] = find(par[i]); // recursively call find, sets the parent of each node in path to rep
    		return par[i]; // returns the rep, which is now the parent of i
    	}
